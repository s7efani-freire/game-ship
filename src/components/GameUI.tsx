...
const GameUI: React.FC<GameUIProps> = ({
  ...
  return (
    <>
      ...
      {/* Game Over Screen */}
      {gameState === 'gameOver' && (
        <div className="absolute inset-0 flex flex-col items-center justify-center z-20 bg-black bg-opacity-70">
          <div className="text-center space-y-6 bg-gradient-to-b from-purple-900 to-indigo-900 p-8 rounded-2xl border-2 border-purple-400 shadow-2xl">
